...
export function Header() {
  ...
  return (
    <header 
      className={`fixed top-0 left-0 right-0 z-[100] transition-all duration-300 bg-white/75 backdrop-blur-md border-b border-gray-100 ${scrolled ? 'shadow-md py-2' : 'py-4'}`}
    >
