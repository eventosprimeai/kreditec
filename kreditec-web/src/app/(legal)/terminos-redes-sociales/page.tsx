...
const obligaciones = [
  ...
  'No introducir, almacenar o difundir mediante los Canales Oficiales programas informáticos, virus, macros, applets, controles ActiveX u otros dispositivos lógicos o secuencias de caracteres que puedan causar daño a KREDITEC.',
  ...
  'No realizar actividades publicitarias o de explotación comercial a través de los Canales Oficiales, y a no utilizar los contenidos y la información del mismo para remitir publicidad.',
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="space-y-12">
            ...
            <div className="ml-12 space-y-3">
              {[
                ...
                <div key={i} className="flex gap-3 p-4 bg-gray-50 dark:bg-[#0d1f13] rounded-xl border border-gray-200 dark:border-[#1a3a22]">
                  <span className="text-[#00bc4c] font-bold text-sm flex-shrink-0">✓</span>
                  <div>
          ...
          <section id="canales" className="scroll-mt-24">
            ...
            <div className="ml-12">
              <div className="p-5 bg-[#002d14] dark:bg-[#001a0c] rounded-xl space-y-3 text-sm">
                ...
                <p className="text-gray-400">Av. 6 de Diciembre N34-360 N35 Portugal | Edificio Zyra | Oficina 605 | Iñaquito, Quito D.M. | Pichincha, Ecuador</p>
                <div className="flex flex-wrap gap-4 pt-2 border-t border-white/10">
                  <a href="mailto:Info@kreditecsa.com" className="text-[#00bc4c] hover:underline">✉️ Info@kreditecsa.com</a>
                  <span className="text-gray-400">📞 +593 96 341 3419</span>
                  <span className="text-gray-500 text-xs">Horario: Lunes a Viernes 08:00 - 17:00 horas</span>
                </div>
              </div>
            </div>
          </section>
          ...
          <section id="objeto" className="scroll-mt-24">
            ...
            <div className="ml-12 space-y-3">
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-[15px]">
                Estos Términos y Condiciones de Uso tienen como objeto regular la puesta a disposición de la información suministrada en los Canales Oficiales, administrados por KREDITEC, así como la interacción de los Usuarios con el contenido y los procesos de contacto, cotización de servicios y postulación laboral que puedan surgir de dicha interacción.
              </p>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-[15px]">
                Tanto la navegación por los Canales Oficiales como cualquier interacción con los contenidos publicados suponen la aceptación como Usuario, sin reservas de ninguna clase, de todas y cada una de estos Términos y Condiciones de Uso.
              </p>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-[15px]">
                KREDITEC podrá modificar, actualizar o eliminar los contenidos y funcionalidades de los Canales Oficiales, y modificar estos Términos y Condiciones de Uso cuando lo estime conveniente para su adecuada funcionalidad y en beneficio de KREDITEC, sin necesidad de previo aviso.
              </p>
            </div>
          </section>
          ...
          <section id="propiedad" className="scroll-mt-24">
            ...
            <div className="ml-12 space-y-3">
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-[15px]">
                Todos los contenidos publicados en los Canales Oficiales y especialmente los diseños, textos, gráficos, logos, iconos, signos, botones, así como el software, los nombres comerciales, las marcas o dibujos industriales y cualesquiera otros signos susceptibles de utilización industrial y comercial están sujetos a derechos de propiedad intelectual e industrial de KREDITEC o de terceros titulares de estos que han autorizado debidamente su inclusión en los Canales Oficiales.
              </p>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-[15px]">
                Queda estrictamente prohibido el uso de los Contenidos publicados en los Canales Oficiales administrados por KREDITEC con fines públicos o comerciales distintos a los determinados por KREDITEC, por lo que el Usuario se abstendrá de explotar, reproducir, distribuir, modificar, comunicar públicamente, ceder, transformar o usar dicho contenido sin la autorización expresa y por escrito de KREDITEC.
              </p>
              <p className="text-gray-700 dark:text-gray-300 text-[15px]">
                En caso de violación a derechos de propiedad intelectual, contáctese a: <a href="mailto:legal@kreditecsa.com" className="text-[#00bc4c] hover:underline font-medium">legal@kreditecsa.com</a>
              </p>
            </div>
          </section>
          ...
          <section id="responsabilidad" className="scroll-mt-24">
            ...
            <div className="ml-12 space-y-3">
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-[15px]">
                Los Canales Oficiales administrados por KREDITEC sirven para poner a disposición de los Usuarios información sobre sus servicios y oportunidades de empleo. Cualquier eventual contratación de servicios se regirá por un contrato separado de prestación de servicios, y no por estos Términos.
              </p>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-[15px]">
                Los servicios ofertados en los Canales Oficiales son lícitos y se encuentran conformes a la legislación ecuatoriana. El acceso a los Canales Oficiales será voluntario, y, por tanto, es responsabilidad del Usuario, todo efecto directo o indirecto que por el uso que haga de los Canales Oficiales se derive.
              </p>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-[15px]">
                KREDITEC no será responsable de los perjuicios que se pudieran derivar de interferencias, omisiones, interrupciones, virus informáticos, averías y/o desconexiones en el funcionamiento operativo de este sistema electrónico o en los aparatos y equipos informáticos de los usuarios.
              </p>
            </div>
          </section>
          ...
          <section id="obligaciones" className="scroll-mt-24">
            ...
            <div className="ml-12 space-y-2">
              <p className="text-gray-700 dark:text-gray-300 text-[15px] mb-4">
                El Usuario se compromete, con carácter general, a utilizar los Canales Oficiales conforme a la ley, a los presentes Términos y Condiciones de Uso, a la moral y a las buenas costumbres. Específicamente, queda prohibido:
              </p>
              {obligaciones.map((item, i) => (
                <div key={i} className="flex gap-3 items-start p-3 bg-gray-50 dark:bg-[#0d1f13] rounded-lg border border-gray-200 dark:border-[#1a3a22]">
                  <span className="text-red-400 font-bold flex-shrink-0 mt-0.5">{String.fromCharCode(96 + i + 1)})</span>
          ...
          <section id="proteccion-datos" className="scroll-mt-24">
            ...
            <div className="ml-12 space-y-3">
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-[15px]">
                Mediante el acceso, ingreso y utilización de los Canales Oficiales el Usuario acepta el tratamiento de los datos personales recopilados al momento de inscribirse en los Canales Oficiales y los datos de navegación.
              </p>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-[15px]">
                KREDITEC declara que no recopilará datos considerados como sensibles o que se tenga derecho a guardar reserva, específicamente datos relacionados con filiación política, creencia religiosa, preferencia sexual y demás datos que las leyes ecuatorianas consideren como sensibles.
              </p>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-[15px]">
                Para ejercer sus derechos de acceso, rectificación, eliminación o anulación de datos personales, el Titular deberá enviar su solicitud a: <a href="mailto:protecciondedatos@kreditecsa.com" className="text-[#00bc4c] hover:underline font-medium">protecciondedatos@kreditecsa.com</a>
              </p>
                ...
                <ol className="space-y-1 list-none">
                  {['Nombre del titular, su domicilio, dirección de correo electrónico y número telefónico.', 'El documento o los documentos mediante los cuales se acredite la personalidad del titular (copia de cédula o documento público).', 'Descripción clara y precisa de los datos personales respecto de los cuales el titular pretende ejercer sus derechos.'].map((req, i) => (
                    <li key={i} className="flex gap-2 text-gray-700 dark:text-gray-300">
                      <span className="text-[#00bc4c] font-bold">{i + 1}.</span>
                      {req}
                    </li>
                  ))}
                </ol>
          ...
          <section id="legislacion" className="scroll-mt-24">
            ...
            <div className="ml-12 space-y-3">
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-[15px]">
                Los presentes Términos y Condiciones de Uso se rigen por las leyes de la República del Ecuador.
              </p>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-[15px]">
                Al utilizar de cualquier manera o interactuar a través de los Canales Oficiales, las partes convienen irrevocablemente que en caso de surgir disputas entre ellas realizarán los mejores esfuerzos para buscar y encontrar una solución mutuamente aceptable.
              </p>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-[15px]">
                Si las partes no pudieren encontrar una solución durante un plazo de <strong className="text-[#002d14] dark:text-white">10 días calendario</strong> contados a partir de la notificación del conflicto a la contraparte, toda controversia derivada de la celebración, interpretación, ejecución, liquidación y terminación de los presentes Términos y Condiciones se resolverá de acuerdo con lo establecido en el Código Orgánico Integral de Procesos, en juicio ordinario ante el juez de lo civil del cantón Quito.
              </p>
            </div>
          </section>
        </div>
