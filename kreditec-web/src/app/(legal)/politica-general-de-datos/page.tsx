...
import { Lock, Archive, Target, Users, Scale, CheckCircle, Shield, Eye, Check, Mail, Phone, MapPin, Database, FileText } from 'lucide-react';
...
const principios = [
  { name: 'Confidencialidad', Icon: Lock, desc: 'KREDITEC garantiza que los datos personales tratados serán manejados con estricta confidencialidad, estando prohibida su divulgación a terceros no autorizados.' },
  { name: 'Conservación', Icon: Archive, desc: 'Los datos personales serán conservados en una forma que permita identificar a los titulares durante no más tiempo del necesario para los fines del tratamiento.' },
  { name: 'Finalidad', Icon: Target, desc: 'Los datos personales serán recopilados de una manera leal y lícita para una o más finalidades específicas informadas al Titular de los datos.' },
  { name: 'Lealtad', Icon: Users, desc: 'KREDITEC se compromete a tratar los datos personales de manera leal, garantizando que los titulares sean informados sobre el uso de sus datos.' },
  { name: 'Minimización y Proporcionalidad', Icon: Scale, desc: 'KREDITEC procesará los datos personales que sean necesarios para las finalidades informadas al Titular. No se recopilarán datos en exceso o que no sean necesarios para una finalidad previamente establecida.' },
  { name: 'Responsabilidad Proactiva', Icon: CheckCircle, desc: 'KREDITEC obtendrá los medios de verificación necesarios para demostrar el cumplimiento de la LOPDP. En caso de que sea necesario, KREDITEC podrá contar con un Delegado de Protección de Datos (DPD).' },
  { name: 'Seguridad', Icon: Shield, desc: 'KREDITEC adoptará las medidas de seguridad que sean necesarias para garantizar la confidencialidad de los datos personales, tomando en consideración el tipo de datos personales a ser tratados.' },
  { name: 'Transparencia', Icon: Eye, desc: 'El tratamiento de datos personales será transparente respecto del Titular de estos. KREDITEC informará y comunicará a los Titulares de los datos personales de una manera clara y sencilla.' },
];
...
const derechos = [
  ...
  { name: 'Revisión de decisiones automatizadas', desc: 'Solicitar revisión humana de decisiones tomadas exclusivamente sobre la base de un tratamiento automatizado.' },
        ...
        <div className="space-y-16">
          ...
          <section id="objeto" className="scroll-mt-24">
            ...
            <div className="space-y-3">
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-[15px]">KREDITEC tiene como principal objetivo el cumplir con la Constitución, Ley Orgánica de Protección de Datos Personales (&ldquo;LOPDP&rdquo;) y normativa relacionada. Es por esto por lo que, KREDITEC respetará todos los derechos reconocidos a los Titulares de los datos personales y adoptará las medidas necesarias para garantizar la seguridad y protección de los mismos.</p>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-[15px]">Esta Política aplica a todos los clientes, proveedores, usuarios, colaboradores y cualquier persona natural cuyos datos personales sean tratados por KREDITEC en el ejercicio de sus actividades.</p>
            </div>
          </section>
              ...
              {principios.map((p, i) => (
                <div key={i} className="p-5 bg-gray-50 dark:bg-[#0d1f13] border border-gray-200 dark:border-[#1a3a22] rounded-xl hover:border-[#00bc4c]/40 transition-colors">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-8 h-8 rounded-lg bg-[#00bc4c]/10 dark:bg-[#00bc4c]/20 flex items-center justify-center flex-shrink-0">
                      <p.Icon size={16} className="text-[#00bc4c]" />
                    </div>
          ...
          <section id="base-legitimadora" className="scroll-mt-24">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-[15px] mb-4">KREDITEC podrá utilizar cualquier base legitimadora que sea aplicable para el tratamiento de datos personales, de acuerdo con la LOPDP, incluyendo:</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {['Consentimiento del Titular', 'Ejecución de un contrato', 'Obligación legal', 'Interés legítimo', 'Interés vital del Titular', 'Interés público'].map((base, i) => (
                <div key={i} className="flex gap-2 items-center p-3 bg-gray-50 dark:bg-[#0d1f13] rounded-lg border border-gray-200 dark:border-[#1a3a22]">
                  <Check size={13} className="text-[#00bc4c] flex-shrink-0" />
          ...
          <section id="comunicacion" className="scroll-mt-24">
            ...
            <div className="space-y-3">
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-[15px]">KREDITEC no adquirirá datos personales o bases de datos que no cuenten con los mecanismos de legitimación correspondiente, así como tampoco transferirá los datos a terceros destinatarios sin contar con la autorización o base legitimadora correspondiente.</p>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-[15px]">En los casos en que sea necesaria una transferencia internacional de datos, KREDITEC exigirá a los terceros el cumplimiento de estándares adecuados de confidencialidad, protección y seguridad conforme la normativa aplicable.</p>
            </div>
          </section>
          ...
          <section id="derechos" className="scroll-mt-24">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-[15px] mb-5">Los Titulares de datos personales podrán ejercer los siguientes derechos frente a KREDITEC, de conformidad con la LOPDP:</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {derechos.map((d, i) => (
                <div key={i} className="p-4 bg-gray-50 dark:bg-[#0d1f13] border border-gray-200 dark:border-[#1a3a22] rounded-xl">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#00bc4c] animate-pulse flex-shrink-0" />
            ...
            <div className="mt-5 p-4 bg-[#002d14] dark:bg-[#001a0c] rounded-xl flex items-center gap-2">
          ...
          <section id="evaluacion" className="scroll-mt-24">
            ...
            <div className="space-y-3">
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-[15px]">KREDITEC realizará evaluaciones periódicas de cumplimiento de la presente Política y de las medidas de seguridad implementadas. Asimismo, KREDITEC capacitará a sus colaboradores en materia de protección de datos personales para garantizar el cumplimiento normativo.</p>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed text-[15px]">En caso de requerirlo, KREDITEC podrá contar con un Delegado de Protección de Datos (&ldquo;DPD&rdquo;), quien será responsable de generar el programa de cumplimiento, obtener las certificaciones necesarias y comunicarse con la Autoridad de Protección de Datos.</p>
            </div>
          </section>
          ...
          <section id="aprobacion" className="scroll-mt-24">
            ...
            <div className="p-5 bg-gray-50 dark:bg-[#0d1f13] border border-gray-200 dark:border-[#1a3a22] rounded-xl">
              <p className="text-gray-700 dark:text-gray-300 text-[15px] leading-relaxed">La presente Política General de Protección de Datos Personales ha sido aprobada por la Gerencia General de KREDITECONK S.A.S. y entra en vigor a partir del <strong className="text-[#002d14] dark:text-white">11 de mayo de 2026</strong>. KREDITEC se reserva el derecho de modificar la presente Política en cualquier momento para adaptarla a cambios normativos o empresariales.</p>
            </div>
          </section>
        </div>
        ...
        <div className="mt-12 p-6 bg-[#002d14] dark:bg-[#001a0c] rounded-2xl">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <p className="text-gray-400 text-xs mt-1 flex items-start gap-1"><MapPin size={11} className="text-[#00bc4c] mt-0.5 flex-shrink-0" /> Av. 6 de Diciembre N34-360 N35 Portugal | Edificio Zyra | Oficina 605 | Iñaquito, Quito D.M.</p>
            </div>
            <div>
              <p className="text-gray-400 text-xs uppercase tracking-wide mb-1">Contacto de Protección de Datos</p>
              <a href="mailto:protecciondedatos@kreditecsa.com" className="text-[#00bc4c] hover:underline text-sm flex items-center gap-1.5"><Mail size={13} /> protecciondedatos@kreditecsa.com</a>
              <p className="text-gray-400 text-sm mt-1 flex items-center gap-1.5"><Phone size={13} className="text-[#00bc4c]" /> +593 96 341 3419</p>
            </div>
          </div>
        </div>
